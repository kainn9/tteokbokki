...
func DrawCircleBody(screen *ebiten.Image, rb tBokiComponents.RigidBody, color color.RGBA) {
...
func DrawPolygonBody(screen *ebiten.Image, rb tBokiComponents.RigidBody, color color.RGBA) {
